...
هاي التقنيات بتهمّ هالقطاع. سبب كل وحدة هو حُكم مكتوب قبل ما نشوف الأدلة،
...
- **[From portal-hopping to instant answers: HEMA’s journey with MCP and Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/from-portal-hopping-to-instant-answers-hemas-journey-with-mcp-and-amazon-bedrock)** — Amazon / AWS (طبقة 1)
  <br>حرارة 90 · news · موجود بالرادار من 2026-09-23 · تاريخ المصدر بيعني _posted_
- **[ai](https://www.npmjs.com/package/ai)** — ناشر غير محدّد
...
**ليش بتهمّ هون.** الفوترة وقياس الاستخدام هي اللي بتقرر إذا الاستخدام رح يتحول لإيراد.

7 إشارة بتحمل هالوسم. أقواهم:

- **[AgenticBooks](https://www.agenticbooks.ai)** — ناشر غير محدّد
  <br>حرارة 73 · repo · شوفناه أول مرة 2026-09-20 · تاريخ المصدر بيعني _updated_
- **[New trends in global card fraud: How 3D Secure and regional mandates are affecting risk](https://stripe.com/blog/new-trends-in-global-card-fraud-how-3d-secure-and-regional-mandates-are-affecting-risk)** — Stripe (طبقة 2)
  <br>حرارة 63 · news · شوفناه أول مرة 2026-09-22 · تاريخ المصدر بيعني _posted_
- **[Analyzing rising fraud attempts among travel and leisure businesses on Stripe](https://stripe.com/blog/analyzing-rising-fraud-attempts-among-travel-and-leisure-businesses-on-stripe)** — Stripe (طبقة 2)
  <br>حرارة 45 · news · شوفناه أول مرة 2026-09-19 · تاريخ المصدر بيعني _posted_
...
الحرارة رقم من 0 لـ100 بينحسب من الحداثة والشعبية والزخم المقيس. أي عامل ما
بينقاس منشيله بدل ما نخمّنه، والنتيجة بتتقلّص حسب كم عامل انقاس فعلًا — يعني
الحرارة معناها *من اللي قدرنا نقيسه هون*.

**"شوفناه أول مرة"** يعني اليوم اللي الرادار شافه فيه يوصل. **"موجود بالرادار
من"** يعني كان موجود لما بلّش السجل، فتاريخه الحقيقي هديك اليوم أو قبله. تاريخ
المصدر بيعني شي مختلف بكل تغذية، ولهيك كل استشهاد بيقول أي حدث بيقصد.

كل الروابط فوق مجمّدة على التاريخ اللي فوق. الرادار بيبدّل حوالي سدس عناصره كل
يوم، فأي ملخّص بيأشّر على التغذية الحيّة بيفسد. هاد لأ.

التقنيات وأسبابها حُكم محلّل واحد، منشور عشان ينحكى فيه. والأدلة تحت كل وحدة
مجموعة آليًا وقابلة للإعادة: نفس المدخلات بتعطي نفس القائمة.

*رادار JBelly · github.com/JBelly-tech/jbelly-radar · CC BY 4.0*
