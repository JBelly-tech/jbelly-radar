...
the radar actually saw this week, so you can check the judgement against it
...
- **[From portal-hopping to instant answers: HEMA’s journey with MCP and Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/from-portal-hopping-to-instant-answers-hemas-journey-with-mcp-and-amazon-bedrock)** — Amazon / AWS (tier 1)
  <br>heat 90 · news · on the radar by 2026-09-23 · source date means _posted_
- **[ai](https://www.npmjs.com/package/ai)** — unattributed
...
**Why it matters here.** Billing and metering decide whether usage turns into revenue.

7 signals carry this tag. The strongest:

- **[AgenticBooks](https://www.agenticbooks.ai)** — unattributed
  <br>heat 73 · repo · first seen 2026-09-20 · source date means _updated_
- **[New trends in global card fraud: How 3D Secure and regional mandates are affecting risk](https://stripe.com/blog/new-trends-in-global-card-fraud-how-3d-secure-and-regional-mandates-are-affecting-risk)** — Stripe (tier 2)
  <br>heat 63 · news · first seen 2026-09-22 · source date means _posted_
- **[Analyzing rising fraud attempts among travel and leisure businesses on Stripe](https://stripe.com/blog/analyzing-rising-fraud-attempts-among-travel-and-leisure-businesses-on-stripe)** — Stripe (tier 2)
  <br>heat 45 · news · first seen 2026-09-19 · source date means _posted_
...
Heat is a 0-100 score computed from freshness, popularity and measured
momentum. A term that cannot be measured for an item is dropped rather than
guessed, and the score is scaled by how much could be measured, so heat means
*of what was actually measurable here*.

**"first seen"** is the day this radar watched the item arrive. **"on the radar
by"** means it was already there when the record began, so the true date is that
day or earlier. A source's own date means a different thing in every feed, which
is why each citation says which event it refers to.

Every link above was frozen on the date at the top. The radar replaces about a
sixth of its items every day, so a brief pointing at the live feed would rot.
This one does not.

The technologies and the reasons are one analyst's judgement, published so it
can be argued with. The evidence under each is machine-collected and
reproducible: the same inputs give the same list.

*JBelly Radar · github.com/JBelly-tech/jbelly-radar · CC BY 4.0*
