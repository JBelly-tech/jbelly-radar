...
(function () {
  ...
  var dict = {
    en: {
      ...
      // v2
      forYou: 'For you', everything: 'Everything', notable: 'From notable organizations',
      ...
      profileOrgs: 'Only notable organizations', profileSave: 'Apply', profileSkip: 'Skip for now',
    ...
    ar: {
      ...
      tier1: 'الفئة الأولى', tier2: 'الفئة الثانية', tier3: 'ملحوظ', verified: 'منظمة موثّقة',
      newSince: 'جديد من آخر زيارة', saved: 'المحفوظ', save: 'احفظ', unsave: 'شيل من المحفوظ',
      hide: 'ما بهمّني', undo: 'تراجع', whyRanked: 'ليش هون',
      matches: 'بيطابق {list}', sourceAffinity: 'بتفتح {source} كثير', explore: 'مجال جديد إلك',
